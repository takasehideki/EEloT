#---
# This code is from the book "Programming Elixir 1.2" by Dave Thomas
# See also Japanese article:
# http://blog.engineer.adways.net/entry/2016/09/23/190255
# 
# Original comment on code is follows:
#---
